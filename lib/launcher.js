...
var Launcher = function(emitter, injector) {
  ...
  this.launch = function(names, hostname, capturePort, urlRoot) {
    var browser;
    var url = 'http://' + hostname + ':' + capturePort + urlRoot;
  ...
  this.launch.$inject = ['config.browsers', 'config.hostname', 'config.capturePort', 'config.urlRoot'];
