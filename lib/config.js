...
var normalizeLauncherUrl = function (launcherUrl) {
  var normalizedLauncherUrl = launcherUrl

  if (normalizedLauncherUrl.charAt(normalizedLauncherUrl.length - 1) !== '/') {
    normalizedLauncherUrl = normalizedLauncherUrl + '/'
  }

  if (normalizedLauncherUrl !== launcherUrl) {
    log.warn('launcherUrl normalized to "%s"', normalizedLauncherUrl)
  }
...
var normalizeConfig = function (config, configFilePath) {
  ...
  // normalize launcherUrl
  if (config.launcherUrl) {
    config.launcherUrl = normalizeLauncherUrl(config.launcherUrl)
  }
