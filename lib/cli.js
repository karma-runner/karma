...
var processArgs = function(argv, options, passedFs, path) {
  ...
  if (!configFile) {
    ...
    if (passedFs.existsSync('./karma.conf.js')) {
      configFile = './karma.conf.js';
    } else if (passedFs.existsSync('./karma.conf.coffee')) {
