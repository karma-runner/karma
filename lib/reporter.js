...
exports.createCustomReporter = function(reporterPath, options, basePath, urlRoot) {
    var isAbsolutePath = /^\//.test(reporterPath);
    var path = (isAbsolutePath)? reporterPath : basePath + '/' + reporterPath;
    var Reporter = require(path).Reporter;
    return new Reporter(options, basePath, createErrorFormatter(basePath, urlRoot));
};
