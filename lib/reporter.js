...
exports.createCustomReporter = function(pathToCustomReporter, options, basePath, urlRoot) {
    var Reporter = require(pathToCustomReporter).Reporter;
    return new Reporter(options, createErrorFormatter(basePath, urlRoot));
};
