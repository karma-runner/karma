    ...
    if (requestUrl === '/context.html' || requestUrl === '/debug.html') {
      return filesPromise.then(function (files) {
        ...
        if (requestUrl === '/context.html' && client && client.contextFile) {
          ...
          requestedFileUrl = isAbsolute(client.contextFile) ?
            client.contextFile :
            path.resolve(client.contextFile)
        } else if (requestUrl === '/debug.html' && client && client.debugFile) {
          fileServer = serveFile
          requestedFileUrl = isAbsolute(client.debugFile) ?
            client.debugFile :
            path.resolve(client.debugFile)
        } else {
