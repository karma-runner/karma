...
describe 'logger', ->
  ...
  describe 'setup', ->
    ...
    it 'should deactivate the global color', ->
      ...
      expect(console.log).to.have.been.calledWith 'INFO [karma]: info'
  ...
  describe 'create', ->
    it 'should allow global logger with default category karma', ->
      m.setup 'DEBUG', false
      log = m.create()
      log.on 'log', logSpy
      log.info 'global msg'
      ...
      expect(event.categoryName).to.equal 'karma'
